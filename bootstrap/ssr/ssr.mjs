...
function Ye(e, t, r, n, i) {
  if ($e || Li("scrollY", window.scrollY), t.toUpperCase() === "GET") {
...
let ht = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  ...
  return () => {
    ...
    return h$1(Fragment, [Boolean(p & 4) && h$1($r, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Ht.Focusable }), Q({ ourProps: m, theirProps: { ...t, ...$ }, slot: d, attrs: t, slots: r, name: "FocusTrap" }), Boolean(p & 4) && h$1($r, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Ht.Focusable })]);
  };
} }), { features: Ki }), Ue = [];
...
let Ft = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", rn = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: Ft }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Ze()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  return Iu(v, L, (E) => {
    ...
    return h$1(Er, { force: true }, () => [h$1(Qi, () => h$1(gu, { target: c.value }, () => h$1(Er, { force: false }, () => h$1(ht, { initialFocus: q, containers: k, features: m.value ? fe(w.value, { parent: ht.features.RestoreFocus, leaf: ht.features.All & ~ht.features.FocusLock }) : ht.features.None }, () => Q({ ourProps: ge, theirProps: F, slot: U, attrs: r, slots: n, visible: d.value === 0, features: Vt.RenderStrategy | Vt.Static, name: "Dialog" }))))), h$1($r, { features: Ht.Hidden, ref: f })]);
  };
} });
...
defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${Ze()}` } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  ...
  return n({ el: s, $el: s }), onMounted(() => {
    ...
    return h$1(Er, { force: true }, () => h$1(Qi, () => Q({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
  };
} });
...
function Ln(e, t, r, n, i, s) {
  ...
  return kt(e, ...i), gr(e, ...t, ...r), a.nextFrame(() => {
    kt(e, ...r), gr(e, ...n), a.add(qu(e, (l) => (kt(e, ...n, ...t), gr(e, ...i), o(l))));
...
let ns = Vt.RenderStrategy, ut = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  i({ el: c, $el: c });
  let { show: d, appear: m } = ku(), { register: p, unregister: g } = Lu(), w = { value: true }, $ = Ze(), A = { value: false }, S = rs(() => {
  ...
  return onMounted(() => {
    ...
    let { appear: L, show: E, enter: T, enterFrom: q, enterTo: F, entered: ge, leave: U, leaveFrom: dt, leaveTo: Pt, ...xe } = e, et = { ref: c }, _e = { ...xe, ...m && d && xt.isServer ? { class: normalizeClass([r.class, xe.class, ...O, ...b]) } : {} };
    return Q({ theirProps: _e, ourProps: et, slot: {}, slots: n, attrs: r, features: ns, visible: f.value === "visible", name: "TransitionChild" });
  };
...
function st(e, t, r) {
  ...
  t && te(e) && (i = e.offsetWidth > 0 && it(n.width) / e.offsetWidth || 1, s = e.offsetHeight > 0 && it(n.height) / e.offsetHeight || 1);
  var a = Ke(e) ? Y(e) : window, o = a.visualViewport, l = !os() && r, u = (n.left + (l && o ? o.offsetLeft : 0)) / i, c = (n.top + (l && o ? o.offsetTop : 0)) / s, f = n.width / i, v = n.height / s;
  return {
    width: f,
    height: v,
    top: c,
...
function lc(e, t, r) {
  r === void 0 && (r = false);
  var n = te(t), i = te(t) && oc(t), s = De(t), a = st(e, i, r), o = {
    scrollLeft: 0,
    scrollTop: 0
  }, l = {
    x: 0,
  ...
  return (n || !n && !r) && ((pe(t) !== "body" || cn(s)) && (o = ac(t)), te(t) ? (l = st(t, true), l.x += t.clientLeft, l.y += t.clientTop) : s && (l.x = un(s))), {
...
var oe = "top", he = "bottom", Le = "right", be = "left", sr = "auto", ar = [oe, he, Le, be], at = "start", Et = "end", dc = "clippingParents", cs = "viewport", vt = "popper", fc = "reference", Mn = /* @__PURE__ */ ar.reduce(function(e, t) {
...
function dn(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = n === void 0 ? e.placement : n, s = r.strategy, a = s === void 0 ? e.strategy : s, o = r.boundary, l = o === void 0 ? dc : o, u = r.rootBoundary, c = u === void 0 ? cs : u, f = r.elementContext, v = f === void 0 ? vt : f, d = r.altBoundary, m = d === void 0 ? false : d, p = r.padding, g = p === void 0 ? 0 : p, w = Rc(typeof g != "number" ? g : Dc(g, ar)), $ = v === vt ? fc : vt, A = e.rects.popper, S = e.elements[m ? $ : v], O = Lc(Ke(S) ? S : S.contextElement || De(e.elements.popper), l, c, a), b = st(e.elements.reference), x = fs({
    reference: b,
    element: A,
    strategy: "absolute",
    placement: i
  }), P = qr(Object.assign({}, A, x)), _ = v === vt ? P : b, k = {
...
function Wn(e) {
  ...
  if (u) {
    ...
    if (b === Y(r) && (b = De(r), ue(b).position !== "static" && o === "absolute" && (x = "scrollHeight", P = "scrollWidth")), b = b, i === oe || (i === be || i === Le) && s === Et) {
      S = he;
...
function td(e) {
  ...
  if (!!b) {
    if (s) {
      var L, E = S === "y" ? oe : be, T = S === "y" ? he : Le, q = S === "y" ? "height" : "width", F = b[S], ge = F + g[E], U = F - g[T], dt = d ? -P[q] / 2 : 0, Pt = $ === at ? x[q] : P[q], xe = $ === at ? -P[q] : -x[q], et = t.elements.arrow, _e = d && et ? ls(et) : {
        width: 0,
        height: 0
      }, Ie = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ps(), ft = Ie[E], qt = Ie[T], Me = Bt(0, x[q], _e[q]), lr = A ? x[q] / 2 - dt - Me - ft - k.mainAxis : Pt - Me - ft - k.mainAxis, Ts = A ? -x[q] / 2 + dt + Me + qt + k.mainAxis : xe + Me + qt + k.mainAxis, ur = t.elements.arrow && ir(t.elements.arrow), xs = ur ? S === "y" ? ur.clientTop || 0 : ur.clientLeft || 0 : 0, mn = (L = C == null ? void 0 : C[S]) != null ? L : 0, _s = F + lr - mn - xs, Is = F + Ts - mn, vn = Bt(d ? Ut(ge, _s) : ge, F, d ? Ge(U, Is) : U);
      b[S] = vn, j[S] = vn - F;
    }
    if (o) {
      var gn, As = S === "x" ? oe : be, Ps = S === "x" ? he : Le, je = b[O], Ct = O === "y" ? "height" : "width", yn = je + g[As], bn = je - g[Ps], cr = [oe, be].indexOf(w) !== -1, wn = (gn = C == null ? void 0 : C[O]) != null ? gn : 0, Sn = cr ? yn : je - x[Ct] - P[Ct] - wn + k.altAxis, On = cr ? je + x[Ct] + P[Ct] - wn - k.altAxis : bn, $n = d && cr ? ed(Sn, je, On) : Bt(d ? Sn : yn, je, d ? On : bn);
      b[O] = $n, j[O] = $n - je;
    }
    t.modifiersData[n] = j;
  }
...
function sd(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = r.boundary, s = r.rootBoundary, a = r.padding, o = r.flipVariations, l = r.allowedAutoPlacements, u = l === void 0 ? pc : l, c = ot(n), f = c ? o ? Mn : Mn.filter(function(m) {
    return ot(m) === c;
...
function od(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? true : a, l = r.fallbackPlacements, u = r.padding, c = r.boundary, f = r.rootBoundary, v = r.altBoundary, d = r.flipVariations, m = d === void 0 ? true : d, p = r.allowedAutoPlacements, g = t.options.placement, w = we(g), $ = w === g, A = l || ($ || !m ? [Mt(g)] : ad(g)), S = [g].concat(A).reduce(function(_e, Ie) {
      ...
      var C = S[k], j = we(C), L = ot(C) === at, E = [oe, he].indexOf(j) >= 0, T = E ? "width" : "height", q = dn(t, {
        placement: C,
        boundary: c,
        rootBoundary: f,
        altBoundary: v,
      ...
      O[T] > b[T] && (F = Mt(F));
      var ge = Mt(F), U = [];
      if (s && U.push(q[j] <= 0), o && U.push(q[F] <= 0, q[ge] <= 0), U.every(function(_e) {
        return _e;
      })) {
        _ = C, P = false;
        break;
    ...
    if (P)
      for (var dt = m ? 3 : 1, Pt = function(Ie) {
        var ft = S.find(function(qt) {
          var Me = x.get(qt);
          if (Me)
            return Me.slice(0, Ie).every(function(lr) {
              return lr;
            });
        });
        if (ft)
...
var Cd = 1, Fd = 2, kd = "[object Boolean]", Ld = "[object Date]", Rd = "[object Error]", Dd = "[object Map]", Bd = "[object Number]", Md = "[object RegExp]", jd = "[object Set]", Nd = "[object String]", Vd = "[object Symbol]", Hd = "[object ArrayBuffer]", Ud = "[object DataView]", Xn = Fe ? Fe.prototype : void 0, br = Xn ? Xn.valueOf : void 0;
...
const Lr = of;
var Jn = "[object Map]", lf = "[object Object]", Qn = "[object Promise]", Zn = "[object Set]", ei = "[object WeakMap]", ti = "[object DataView]", uf = Je(Cr), cf = Je(Ot), df = Je(Fr), ff = Je(kr), pf = Je(Lr), He = Re;
(Cr && He(new Cr(new ArrayBuffer(1))) != ti || Ot && He(new Ot()) != Jn || Fr && He(Fr.resolve()) != Qn || kr && He(new kr()) != Zn || Lr && He(new Lr()) != ei) && (He = function(e) {
...
function or(e, t, r, n, i) {
  return e === t ? true : e == null || t == null || !ke(e) && !ke(t) ? e !== e && t !== t : vf(e, t, r, n, or, i);
}
var gf = 1, yf = 2;
function bf(e, t, r, n) {
...
function Lf(e, t, r) {
  ...
  if (!n)
    return -1;
  var i = r == null ? 0 : fn(r);
  return i < 0 && (i = kf(n + i, 0)), qf(e, At(t), i);
}
var Rf = Pf(Lf);
const pn = Rf, Df = {
  props: {
      ...
      new Proxy(
        {},
        {
          ...
          get(t, r) {
            ...
            return r === "$response" ? e.response : n.includes(r) || tt(r, "__v_") ? e[r] : (!e.isMounted && !Z(e.values, r) && (e.missingAttributes.push(r), e.$put(r, "")), ye(e.values, r));
          },
          set(t, r, n) {
            return e.$put(r, n);
          }
