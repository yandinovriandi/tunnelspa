            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('transaction.create')" :active="request()->routeIs('transaction*')">
                            {{ __('Balance') }}
                        </x-nav-link>
                    </div>
                </div>
...
{{--                                    </x-dropdown-link>--}}
        ...
        <div v-bind:class="{ block: toggled, hidden: !toggled }" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('transaction.create')" :active="request()->routeIs('transaction.*')">
                    {{ __('Saldo') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('server.index')" :active="request()->routeIs('server*')">
                    {{ __('Servers') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('tunnels.index')" :active="request()->routeIs('tunnels*')">
                    {{ __('Tunnels') }}
                </x-responsive-nav-link>
            </div>
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('server.index')">
                        {{ __('Server') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('tunnels.index')">
                        {{ __('Tunnels') }}
                    </x-responsive-nav-link>
